...
* **Frontend**: React (Vite) + Tailwind CSS, served via **Nginx** as a reverse proxy.
...
* **AI Microservice**: **Python (FastAPI)** running **LSTM Neural Networks** for price prediction.
* **Analysis Microservice**: **Python (FastAPI)** for calculating Technical Indicators (RSI, MA, etc.).
