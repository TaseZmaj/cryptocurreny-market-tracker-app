...
function TechnicalAnalysisCard({ type, datePicker, sx }) {
  ...
  const data = filteredTechnicalAnalysisData?.last_candle;

  // ================== BOLLINGER BANDS position calucaltion logic ================
  const price = coin?.lastPrice;
  const lowerBand = data?.bb_lower;
  const upperBand = data?.bb_upper;
  const position =
  ...
  const vma = type === "vma" ? data?.vma_20 : null;
    ...
    >
      ...
      !coinTechnicalAnalysisError ? (
        ...
        >
          ...
          {type === "rsiPanel" ? <RsiProgressBar value={data?.rsi} /> : null}
          {type === "macdPanel" ? (
            <>
              <Indicator isCurrency={false} data={data?.macd.toFixed(2)}>
                MACD:
              </Indicator>
              <Indicator isCurrency={false} data={data?.macd_signal.toFixed(2)}>
                Signal:
              </Indicator>
              <Typography
                sx={{
          ...
          {type === "stochasticPanel" ? (
            <>
              <Indicator isCurrency={false} data={data?.stoch_k.toFixed(2)}>
                %K:
              </Indicator>
              <Indicator isCurrency={false} data={data?.stoch_d.toFixed(2)}>
                %D:
              </Indicator>
              <Typography
                sx={{
          ...
          {type === "adxPanel" ? (
            ...
            >
              <Indicator isCurrency={false} data={data?.adx.toFixed(2)}>
                ADX:
              </Indicator>
              <Typography
                sx={{
          ...
          {type === "cciPanel" ? (
            ...
            >
              <Indicator isCurrency={false} data={data?.cci.toFixed(2)}>
                CCI:
              </Indicator>
              <Typography
                sx={{
